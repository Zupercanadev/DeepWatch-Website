...
<html class="wide wow-animation" lang="en">
  ...
  <body>
   ...
   <div class="page-loader">
      <div class="page-loader-body-hope-help align-center">
        ...
        <div class="fullwidth-page-inner">
          <div class="section-md text-center">
            <div class="shell">
			  ...
			  <h5>Please enter in your email</h5>
              <div class="range range-xs-center">
				...
				<?php
					...
					if($error_Found)
					{
						echo "<div class='form-error text-center'>";
							...
							else if($error == "RESETEXISTS")
							{
								echo "Reset code has already sent. Codes expire every 15 minutes. Please check you spam folder.";	
							}
				...
				?>
                  <!-- RD Mailform-->
                  <form id="forgot_frm" method="POST" action="bat\forgot-pass-send-code.php">
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="forms-login-name" type="email" name="email" data-constraints="@Required @Email">
