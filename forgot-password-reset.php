        ...
        <div class="fullwidth-page-inner">
          <div class="section-md text-center">
            <div class="shell">
			  ...
			  <h5>Please enter in your new password</h5>
              <div class="range range-xs-center">
				...
				?>
                  <!-- RD Mailform-->
                  <form id="login_frm" method="POST" action="bat\reset-password.php">
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="forms-login-name" type="password" name="password" data-constraints="@Required" required>
                      <label class="form-label" for="forms-login-name">New Password</label>
                    </div>
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="forms-login-password" type="password" name="confirm-password" data-constraints="@Required" required>
                      <label class="form-label" for="forms-login-password">Confirm Password</label>
                    </div>
                    <div class="form-button">
                      <button class="button button-sm button-default-outline button-nina" type="submit">Save</button>
                    </div>
                  </form>
                </div>
              </div>
