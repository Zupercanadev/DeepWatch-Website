        ...
        <div class="fullwidth-page-inner">
          <div class="section-md text-center">
            <div class="shell">
			  ...
			  <h5>We have sent to your email address a 4 digit code. Please enter it in below.</h5>
			  Dont forgot to check your spam folder.
              <div class="range range-xs-center">
				...
				<?php
					...
					if($error_Found)
					{
						echo "<div class='form-error text-center'>";
							...
							if($error == "CODENOTFOUND")
							{
								echo "Code was incorrect.";
							}
				...
				?>
                  <!-- RD Mailform-->
                  <form id="login_frm" method="POST" action="bat/authenticate-reset-code.php?<?php echo $userId; ?>">
                    <div class="form-wrap form-wrap-validation">
                      <input class="form-input" id="forms-login-name" type="text" name="code" data-constraints="@Required">
                      <label class="form-label" for="forms-login-name">Code</label>
                    </div>
                    <div class="form-button">
                      <button class="button button-sm button-default-outline button-nina" type="submit">Next</button>
                    </div>
                  </form>
                </div>
              </div>
